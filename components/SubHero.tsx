    ...
    >
      ...
      <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
        <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
          The friction isn't the savings. It's the uncertainty.
        </h2>
        <p className="mt-6 text-lg tracking-tight text-blue-100">
          Most homeowners don't avoid self-directed transactions because they lack the savings motive. They avoid them because the process feels complex, opaque, and high-risk. Cladex removes that friction with structured workflow, clear stage progression, and deterministic risk scoring.
        </p>
      </div>
