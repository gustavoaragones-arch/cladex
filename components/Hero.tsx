    ...
    <div className=" px-4">
      ...
      <div className="relative z-10 max-w-7xl mx-auto mt-32">
        ...
        <p className="mx-auto mt-6 max-w-3xl text-xl tracking-tight text-zinc-600 text-center leading-normal">
          Cladex is structured transaction workflow software for real estate buyers and sellers. Guided stages, deterministic offer scoring, and real-time risk monitoring — without acting as broker, attorney, or escrow.
        </p>
